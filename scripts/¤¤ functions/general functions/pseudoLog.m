...
% empowering small values and supresing low values, but can be tailored to
% accomodate need for degree of suppression and empowerment of large and
...
% namely it is non-negative and defined at zero (power function) and it
% can strongly suppress large values (log).
