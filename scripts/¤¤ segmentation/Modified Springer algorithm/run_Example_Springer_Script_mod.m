...
springer_options = default_Springer_HSMM_options_mod;
springer_options
...
%% Train the HMM:
[B_matrix, pi_vector, total_obs_distribution] = trainSpringerSegmentationAlgorithmMod(train_recordings,train_annotations,springer_options.audio_Fs, false);
...
%         test_recordings{PCGi}, springer_options.audio_Fs, B_matrix, pi_vector, total_obs_distribution, true);
    runSpringerSegmentationAlgorithmMod...
                   (test_recordings{PCGi}, springer_options.audio_Fs, HMMpar,[],true)
end
