...
function [logistic_regression_B_matrix, pi_vector, total_obs_distribution] = trainSpringerSegmentationAlgorithmMod(PCGCellArray, annotationsArray, Fs, figures)
...
for PCGi = 1:length(PCGCellArray)
    ...
    [PCG_Features, featuresFs] = getSpringerPCGFeaturesMod(PCG_audio, Fs);
