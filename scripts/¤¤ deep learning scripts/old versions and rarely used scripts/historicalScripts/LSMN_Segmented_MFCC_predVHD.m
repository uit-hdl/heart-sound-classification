...
IposCases = or(HSdataTrain.MRGRADE_T72>=mg,...
            HSdataTrain.Murmur_4_grade_ref_ny_T72>=mg);
...
% first attempt using MFFC+segmentation algorithm to predict MR grade 2 or
% higher. I get sensitivity and specificity of 60% and 42% respectively,
% and a ROC curve that it is hardly any better than a 50-50 guess.
